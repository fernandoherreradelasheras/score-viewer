...
export default function SplitViewSelector({
  ...
  const splitViewContentSelectorLabel = useMemo(() =>
    splitViewOrientation === "horizontal" ? t('heading.splitViewSelectorHorizontal') : t('heading.splitViewSelectorVertical')
    , [splitViewOrientation, t]);
